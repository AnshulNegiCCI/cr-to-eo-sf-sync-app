...
payload map ((account) -> {
 ...
 "EIA_Expense_Go_Live__c": account.EIA_Expense_Go_Live__c,
 "EIA_Invoice_Go_Live__c": account.EIA_Invoice_Go_Live__c,
 ...
 "engagio__PipelineDate__c": (account.engagio__PipelineDate__c as Date {format: "yyyy-MM-dd"}) default null,
 ...
 "ESA_Expense_Go_Live__c": account.ESA_Expense_Go_Live__c ,
 "ESA_Invoice_Go_Live__c": account.ESA_Invoice_Go_Live__c,
...
"NetSuite_External_ID__c": account.NetSuite_External_ID__c,
 ...
 "Original_MQA_Date__c": (account.Original_MQA_Date__c DateTime {format: "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"}) default null,
 ...
 "Recent_MQA_Date__c": (account.Recent_MQA_Date__c DateTime {format: "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"}) default null,
 "SBQQ__IgnoreParentContractedPrices__c": (account.SBQQ__IgnoreParentContractedPrices__c as Boolean) default null,
 "SBQQ__PriceHoldEnd__c": account.SBQQ__PriceHoldEnd__c,
